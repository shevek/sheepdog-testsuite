...
public class VdiWriteOperator extends AbstractProcessOperator {
    ...
    protected TargetProcess newProcess(TargetContext context) {
        ...
        OutputProcess process = new OutputProcess(context, output, context.getCollie(), "vdi", "write", "-p", String.valueOf(port), vdi, String.valueOf(offset), String.valueOf(length));
        return process;
    }
}
